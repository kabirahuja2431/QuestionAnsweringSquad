...
from qa_model import QAModel, QAModelPtr, QAModelTrans
...
tf.app.flags.DEFINE_integer("char_len",30,"The maximum length of characters in a word")
tf.app.flags.DEFINE_integer("embedding_size", 100, "Size of the pretrained word vectors. This needs to be one of the available GloVe dimensions: 50/100/200/300")
tf.app.flags.DEFINE_integer("char_embedding_size",20,"Size of character embeddings")
tf.app.flags.DEFINE_integer("char_vocab_len",489,"Number of characters in vocabulary")
tf.app.flags.DEFINE_integer("num_filters",100,"Number of filters to use in convolution")
tf.app.flags.DEFINE_integer("kernel_size",5,"Number of kernels to use in convolution")
...
def main(unused_argv):
	...
	# Initialize model
	qa_model = QAModelTrans(FLAGS, id2word, word2id, emb_matrix)
