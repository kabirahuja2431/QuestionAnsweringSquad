...
class QAModel_BIDAF(object):
    ...
    def build_graph(self):
        ...
        attn_layer = BiDAF(self.keep_prob, self.FLAGS.hidden_size)
        ...
        hidden_fc = tf.contrib.layers.fully_connected(attn_output, num_outputs=self.FLAGS.hidden_size) # blended_reps_final is shape (batch_size, context_len, hidden_size)
